...
public interface EpackJoinRepository extends JpaRepository<Epack, Integer>{
	@Query(nativeQuery =true, value = "SELECT q.qp_id, q.maximum_marks, i.instruction_id, i.instruction_text, q.duration, b.batch_id, "
			...
			+ "ea_course_master co ON e.course_master_id = co.course_master_id WHERE c.center_id = :center_id")
	List<Object[]> fetchEpack1Data(@Param("center_id") int center_id);
