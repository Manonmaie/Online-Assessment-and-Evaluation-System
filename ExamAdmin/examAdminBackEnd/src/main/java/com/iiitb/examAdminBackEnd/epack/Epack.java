...
public class Epack {
	...
	public Epack(int epack_header_id, String epack_desc, LocalDateTime created_on, String created_by,
			String epack_status, LocalDateTime epack_sent_on, String epack_path, int center_id) {
		super();
	...
	public List<Epack1> getEpack1List() {
		return epack1List;
	}

	public void setEpack1List(List<Epack1> epack1List) {
		this.epack1List = epack1List;
	}
