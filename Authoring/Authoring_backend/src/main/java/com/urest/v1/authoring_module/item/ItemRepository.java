...
public interface ItemRepository extends CrudRepository<Item, Integer> {
	...
	@Query(nativeQuery =true,value = "SELECT * FROM au_item as i WHERE i.cognitive_level IN (:cgLvl) AND i.difficulty_level IN (:difLvl) AND i.item_type IN (:type) AND i.marks BETWEEN (:startMark) AND (:endMark)")   
