...
CREATE TABLE `out_apack_header` (
  ...
  `apack_status` varchar(255) DEFAULT NULL,
...
INSERT INTO `out_apack_header` VALUES (1,'Nothing',NULL,NULL,'CREATED','Author','2020-11-30 18:15:52');
...
INSERT INTO `apack2` VALUES (1,1,1,1,'Collection of related data',1,1),(2,1,2,0,'Collection of data',1,1),(3,1,3,0,'Collection of words',1,1),(4,1,4,0,'Collection of people',1,1),(5,2,5,1,'Primary Key',3,3),(6,2,5,1,'Primary Key',9,9),(7,2,6,0,'Personal Key',3,3),(8,2,6,0,'Personal Key',9,9),(9,2,7,0,'Person Key',3,3),(10,2,7,0,'Person Key',9,9),(11,2,8,0,'Primary Keyword',3,3),(12,2,8,0,'Primary Keyword',9,9),(13,3,9,0,'Foreign Key',2,2),(14,3,10,1,'Foreign Keyword',2,2),(15,3,11,0,'Fashion Key',2,2),(16,3,12,0,'Forward Key',2,2),(17,9,1,100,'True',8,8),(18,9,1,0,'False',8,8),(19,8,2,0,'True',4,4),(20,8,2,100,'False',4,4);
...
-- Dump completed on 2020-11-30 18:15:52
Dump execute Failed
creating dump
