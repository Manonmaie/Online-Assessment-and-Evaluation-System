...
INSERT INTO `out_epack_header` VALUES (1,'Nothing','2020-12-01 13:56:44','Author','CREATED',NULL,NULL,1),(2,'Nothing','2020-12-01 13:57:37','Author','CREATED',NULL,NULL,1),(3,'Nothing','2020-12-01 13:58:28','Author','CREATED',NULL,NULL,1),(4,'Nothing','2020-12-01 14:07:50','Author','CREATED',NULL,NULL,1),(5,'Nothing','2020-12-01 14:08:01','Author','CREATED',NULL,NULL,3),(6,'Nothing','2020-12-01 14:12:25','Author','CREATED',NULL,NULL,3);
...
INSERT INTO `epack1` VALUES (8,6,1,100,1,'Exam duration is 3 hrs',180,4,'batch1','2020-09-23 10:00:00','2020-09-23 13:00:00',3,'IITB','Indian Institute of Technology, Mumbai',1,'MID','Mid Term Examination',1,'dbms_101','DBMS'),(9,6,1,100,2,'It has two sections',180,4,'batch1','2020-09-23 10:00:00','2020-09-23 13:00:00',3,'IITB','Indian Institute of Technology, Mumbai',1,'MID','Mid Term Examination',1,'dbms_101','DBMS'),(10,6,1,100,3,'Each section contributes to 50% of the total marks',180,4,'batch1','2020-09-23 10:00:00','2020-09-23 13:00:00',3,'IITB','Indian Institute of Technology, Mumbai',1,'MID','Mid Term Examination',1,'dbms_101','DBMS'),(11,6,2,50,4,'Exam duration is 2 hrs',120,5,'batch2','2020-10-23 10:00:00','2020-10-23 13:00:00',3,'IITB','Indian Institute of Technology, Mumbai',1,'MID','Mid Term Examination',1,'dbms_101','DBMS'),(12,6,2,50,5,'It has only one section',120,5,'batch2','2020-10-23 10:00:00','2020-10-23 13:00:00',3,'IITB','Indian Institute of Technology, Mumbai',1,'MID','Mid Term Examination',1,'dbms_101','DBMS'),(13,6,3,25,6,'Exam duration is 1 hr',60,6,'batch3','2020-12-23 10:00:00','2020-12-23 13:00:00',3,'IITB','Indian Institute of Technology, Mumbai',2,'END','End Term Examination',2,'dm_102','Data Modelling'),(14,6,3,25,7,'It has only one section with no negative marking',60,6,'batch3','2020-12-23 10:00:00','2020-12-23 13:00:00',3,'IITB','Indian Institute of Technology, Mumbai',2,'END','End Term Examination',2,'dm_102','Data Modelling');
...
INSERT INTO `epack3` VALUES (17,10,1,1,'Collection of related data'),(18,10,1,2,'Collection of data'),(19,10,1,3,'Collection of words'),(20,10,1,4,'Collection of people'),(21,11,2,9,'Foreign Key'),(22,11,2,10,'Foreign Keyword'),(23,11,2,11,'Fashion Key'),(24,11,2,12,'Forward Key'),(25,13,4,1,'True'),(26,13,4,1,'False'),(27,17,8,2,'True'),(28,17,8,2,'False'),(29,18,9,5,'Primary Key'),(30,18,9,6,'Personal Key'),(31,18,9,7,'Person Key'),(32,18,9,8,'Primary Keyword');
...
INSERT INTO `epack4` VALUES (1,8,4,6,1,'S1','ABC','abc','CSE','ABC@iiitb.org','IIITB'),(2,8,4,8,2,'S2','ZYX','xyz','null','null','null'),(3,11,5,7,1,'S1','ABC','abc','CSE','ABC@iiitb.org','IIITB'),(4,11,5,9,2,'S2','ZYX','xyz','null','null','null'),(5,13,6,10,2,'S2','ZYX','xyz','null','null','null');
...
-- Dump completed on 2020-12-01 14:12:27
Dump execute Success
2020-12-01 16:06:09.552  INFO 5243 --- [extShutdownHook] j.LocalContainerEntityManagerFactoryBean : Closing JPA EntityManagerFactory for persistence unit 'default'
2020-12-01 16:06:09.555  INFO 5243 --- [extShutdownHook] o.s.s.concurrent.ThreadPoolTaskExecutor  : Shutting down ExecutorService 'applicationTaskExecutor'
2020-12-01 16:06:09.556  INFO 5243 --- [extShutdownHook] com.zaxxer.hikari.HikariDataSource       : HikariPool-1 - Shutdown initiated...
2020-12-01 16:06:09.567  INFO 5243 --- [extShutdownHook] com.zaxxer.hikari.HikariDataSource       : HikariPool-1 - Shutdown completed.
