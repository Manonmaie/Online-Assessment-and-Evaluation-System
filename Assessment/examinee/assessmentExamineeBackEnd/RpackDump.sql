...
INSERT INTO `out_rpack_header` VALUES (1,'Nothing','2020-12-01 18:44:05','Author','SENT','2020-12-01 18:44:05',NULL);
...
INSERT INTO `rpack1` VALUES (1,1,1,100,180,4),(2,1,2,50,120,5),(3,1,3,25,60,6);
...
INSERT INTO `rpack3` VALUES (1,1,1,1,'Collection of related data'),(2,1,1,2,'Collection of data'),(3,1,1,3,'Collection of words'),(4,1,1,4,'Collection of people'),(5,2,2,9,'Foreign Key'),(6,2,2,10,'Foreign Keyword'),(7,2,2,11,'Fashion Key'),(8,2,2,12,'Forward Key'),(9,4,4,1,'True'),(10,4,4,1,'False'),(11,8,8,2,'True'),(12,8,8,2,'False'),(13,9,9,5,'Primary Key'),(14,9,9,6,'Personal Key'),(15,9,9,7,'Person Key'),(16,9,9,8,'Primary Keyword');
...
INSERT INTO `rpack4` VALUES (1,1,1,4,6,1,1,1,'Collection of related data'),(2,1,1,4,8,2,1,1,'Collection of related data'),(3,2,1,4,6,1,2,2,'Foreign Key'),(4,2,1,4,6,1,2,3,'Foreign Keyword'),(5,2,1,4,8,2,2,2,'Foreign Key'),(6,2,1,4,8,2,2,3,'Foreign Keyword');
...
-- Dump completed on 2020-12-01 18:44:05
